...
const between = [
  ...
  <Alert severity="warning">
    Define expense catagories and allocate a portion of your income to each catagory, include both essential and
...
const over = [
  ...
  <Alert severity="success">
    Invest your money in things such as stocks or mutual funds; talk with a financial advisor to find the best
